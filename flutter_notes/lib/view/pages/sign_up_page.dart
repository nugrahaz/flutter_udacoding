...
class _SignUpPageState extends State<SignUpPage> {
  ...
  void initState() {
    super.initState();
    AppSystemManager.systemBarColorCustom(Colors.transparent, Colors.white);
  }
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      (inProgress == true)
                          ...
                          : CustomButton(
                              heightWidget: SizeConfig.blockHeight * 7,
...
registerUser(var email, var name, var password, BuildContext context) async {
  var url = 'http://192.168.43.48/flutter-notes/signup.php';
  ...
  if (res.statusCode == 200) {
    if (jsonDecode(res.body) == "account already exist") {
      ...
      if (jsonDecode(res.body.toString()) == "true") {
        Fluttertoast.showToast(
            msg: "Akun berhasil dibuat, silahkan login dengan akun yang baru dibuat tadi",
            backgroundColor: Colors.blueGrey,
            toastLength: Toast.LENGTH_LONG);
